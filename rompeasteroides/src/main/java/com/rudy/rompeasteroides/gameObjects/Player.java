...
import com.rudy.rompeasteroides.states.GameState;
...
public class Player extends MovingObject{
	...
	public void draw(Graphics g) {
		...
		AffineTransform at1 = AffineTransform.getTranslateInstance(position.getX() + width/2 + 17,position.getY() + height/2 + 10);
		
		AffineTransform at2 = AffineTransform.getTranslateInstance(position.getX() + 17, position.getY() + height/2 + 10);
		
		at1.rotate(angle, -17, -10);
		at2.rotate(angle, width/2 -17, -10);
