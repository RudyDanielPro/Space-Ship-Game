...
import com.rudy.rompeasteroides.gameObjects.Message;
import com.rudy.rompeasteroides.gameObjects.Meteor;
import com.rudy.rompeasteroides.gameObjects.MovingObject;
import com.rudy.rompeasteroides.gameObjects.Player;
import com.rudy.rompeasteroides.gameObjects.PowerUp;
import com.rudy.rompeasteroides.gameObjects.PowerUpTypes;
import com.rudy.rompeasteroides.gameObjects.Size;
import com.rudy.rompeasteroides.gameObjects.Ufo;
import com.rudy.rompeasteroides.graphics.Animation;
import com.rudy.rompeasteroides.graphics.Assets;
import com.rudy.rompeasteroides.graphics.Sound;
...
public class GameState extends State{
    ...
    // Calcular la posición para la esquina derecha
             String scoreToString = Integer.toString(score);
             int padding = 20;  // Margen desde el borde derecho
             int xPosition = Constants.WIDTH - padding - (scoreToString.length() * 20);  // Ancho del texto * 20 (ancho de cada número)
                int yPosition = 25;  // Posición fija en Y, cerca de la parte superior
    
    // Dibujar cada dígito del puntaje
            for (int i = 0; i < scoreToString.length(); i++) {
             int digit = Integer.parseInt(scoreToString.substring(i, i + 1));
             g.drawImage(Assets.numbers[digit], xPosition, yPosition, null);
             xPosition += 20;  // Desplazar la posición en X para el siguiente dígito
    }
}
